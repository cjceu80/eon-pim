...
/**
* @method static \Pimcore\Model\DataObject\GameWorld\Listing getList(array $config = [])
* @method static \Pimcore\Model\DataObject\GameWorld\Listing|\Pimcore\Model\DataObject\GameWorld|null getByExternalId(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\GameWorld\Listing|\Pimcore\Model\DataObject\GameWorld|null getByOwner(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\GameWorld\Listing|\Pimcore\Model\DataObject\GameWorld|null getByTemplateRef(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\GameWorld\Listing|\Pimcore\Model\DataObject\GameWorld|null getByStatus(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\GameWorld\Listing|\Pimcore\Model\DataObject\GameWorld|null getByName(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
* @method static \Pimcore\Model\DataObject\GameWorld\Listing|\Pimcore\Model\DataObject\GameWorld|null getByIsActive(mixed $value, ?int $limit = null, int $offset = 0, ?array $objectTypes = null)
*/

class GameWorld extends Concrete
{
...
* @param \Pimcore\Model\DataObject\GameWorldTemplate|null $templateRef
* @return $this
*/
